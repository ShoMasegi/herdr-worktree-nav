...
in its Herdr configuration directory, but it never writes that file. It does not read your
credentials, send anything anywhere, or run any command a repository supplies. Network
